    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-md md:text-lg max-w-3xl mx-auto text-gray-700 px-3">
          Developed by final year students of SNJB College of Engineering, CPMS (College Placement Management System) is a powerful web-based platform to streamline and manage campus placements efficiently.
        </p>
      </div>
